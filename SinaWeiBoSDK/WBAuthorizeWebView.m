...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        cannelButton.frame = CGRectMake(430, 5, 25, 25);
        cannelButton.backgroundColor = [UIColor clearColor];
        cannelButton.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"close.png"]];
        [cannelButton addTarget:self action:@selector(cannleSina:) forControlEvents:UIControlEventTouchUpInside];
        cannelButton.adjustsImageWhenHighlighted = NO;
        [panelView addSubview:cannelButton];
...
- (void)cannleSina:(id)sender{
    [delegate authorizeWebView:self didReceiveAuthorizeCode:@"21330"];
}
...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    if (UIInterfaceOrientationIsLandscape(orientation))
    {
        ...
        [panelView setFrame:CGRectMake(282, 134, 460, 500)];
        [containerView setFrame:CGRectMake(10, 10, 440, 480)];
        [webView setFrame:CGRectMake(0, 0, 440, 480)];
//        [panelView setFrame:CGRectMake(0 , 10, 1024 , 748)];
//        [containerView setFrame:CGRectMake(10, 10, 1024, 738)];
//        [webView setFrame:CGRectMake(0, 10, 1024, 738)];
    ...
    //[self setCenter:CGPointMake(384-40, 512+200)];
