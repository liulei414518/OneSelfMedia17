...
- (NSMutableData *)postBody
{
    ...
    if (postDataType == sinakWBRequestPostDataTypeNormal)
    {
        [WBRequest appendUTF8Body:body dataString:[WBRequest stringFromDictionary:params]];
    }
    else if (postDataType == sinakWBRequestPostDataTypeMultipart)
    {
...
- (void)connect
{
    ...
    {
        if (postDataType == sinakWBRequestPostDataTypeMultipart)
        {
