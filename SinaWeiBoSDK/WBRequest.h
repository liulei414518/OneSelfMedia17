...
typedef enum
{
    sinakWBRequestPostDataTypeNone,
	sinakWBRequestPostDataTypeNormal,			// for normal data post, such as "user=name&password=psd"
	sinakWBRequestPostDataTypeMultipart,        // for uploading images and files.
